...
public class WechatController {
    ...
    public String userInfo(@RequestParam("code") String code,
        ...
        try {
            ...
            log.error("【微信网页授权】{}", e);
            throw new SellException(ExceptionEnum.WECHAT_MP_ERROR.getCode(), e.getError().getErrorMsg());
        }
    ...
    public String qrUserInfo(@RequestParam("code") String code,
        ...
        try {
            ...
            log.error("【微信网页授权】{}", e);
            throw new SellException(ExceptionEnum.WECHAT_OPEN_ERROR.getCode(), e.getError().getErrorMsg());
        }
